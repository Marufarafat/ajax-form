    ...
    <body>
        <div class="container">  
            <form id="contact" action="result.php" method="post" class="ajax">
                ...
                <fieldset>
                    <input name="number" placeholder="Your Phone Number" type="tel" tabindex="3" required>
                </fieldset>
                <fieldset>
                    <input name="url" placeholder="Your Web Site starts with http://" type="url" tabindex="4" required>
                </fieldset>
                <fieldset>
